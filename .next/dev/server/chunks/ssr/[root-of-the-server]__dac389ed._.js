...
function CapsulesPage() {
    ...
    const fetchCapsules = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Time__capsule$2f$Gift__Time__Capsule$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        ...
        try {
            const contract = new __TURBOPACK__imported__module__$5b$project$5d2f$Time__capsule$2f$Gift__Time__Capsule$2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$contract$2f$contract$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Contract"](CONTRACT_ADDRESS, CONTRACT_ABI, provider);
            ...
            rawGifts.forEach((gift)=>{
                try {
                    ...
                    const isEth = gift.tokenAddress === __TURBOPACK__imported__module__$5b$project$5d2f$Time__capsule$2f$Gift__Time__Capsule$2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].ZeroAddress;
                    const tokenSymbol = isEth ? "ETH" : "USDC";
                    const decimals = isEth ? 18 : 6;
                    const formattedAmount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Time__capsule$2f$Gift__Time__Capsule$2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$utils$2f$units$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["formatUnits"])(gift.amount, decimals);
            ...
            if (!capsule.isUnlocked && !capsule.isWithdrawn && capsule.unlockDate) {
                ...
                if (timeUntilUnlock > 0 && timeUntilUnlock < 86400000) {
                    const timerId = setTimeout(()=>{
                        setMyReceivedCapsules((currentCapsules)=>currentCapsules.map((c)=>{
                                if (c.id === capsule.id) {
                                    return {
                                        ...c,
                                        isUnlocked: true,
    ...
    const handleClaim = async ()=>{
        ...
        setIsClaiming(true);
        try {
            const contract = new __TURBOPACK__imported__module__$5b$project$5d2f$Time__capsule$2f$Gift__Time__Capsule$2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$contract$2f$contract$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Contract"](CONTRACT_ADDRESS, CONTRACT_ABI, signer);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__dac389ed._.js.map