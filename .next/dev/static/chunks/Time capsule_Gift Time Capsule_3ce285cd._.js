                    ...
                    try {
                        ...
                        if (contract.giftCounter && contract.getGiftDetails) {
                            ...
                            for(let i = 1; i <= Number(counter); i++){
                                promises.push(contract.getGiftDetails(i).catch({
                                    "HomePage.useEffect.fetchStats": ()=>null
                            ...
                            results.forEach({
                                "HomePage.useEffect.fetchStats": (gift)=>{
                                    ...
                                    if (tokenAddr === __TURBOPACK__imported__module__$5b$project$5d2f$Time__capsule$2f$Gift__Time__Capsule$2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].ZeroAddress) {
                                        totalEthValue += parseFloat((0, __TURBOPACK__imported__module__$5b$project$5d2f$Time__capsule$2f$Gift__Time__Capsule$2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$utils$2f$units$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatEther"])(amount));
                                    } else {
                                        totalUsdcValue += parseFloat((0, __TURBOPACK__imported__module__$5b$project$5d2f$Time__capsule$2f$Gift__Time__Capsule$2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$utils$2f$units$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatUnits"])(amount, 6)); // Assuming USDC has 6 decimals
                                    }
                                }
                            }["HomePage.useEffect.fetchStats"]);
                        }
                        ...
                        if (contract.redPacketCounter && contract.getRedPacketDetails) {
                            ...
                            for(let i = 1; i <= Number(rpCounter); i++){
                                rpPromises.push(contract.getRedPacketDetails(i).catch({
                                    "HomePage.useEffect.fetchStats": ()=>null
                                }["HomePage.useEffect.fetchStats"]));
                            }
                            const rpResults = await Promise.all(rpPromises);
                            rpResults.forEach({
                                "HomePage.useEffect.fetchStats": (rp)=>{
                                    if (!rp) return;
                                    const tokenAddr = rp.tokenAddress || rp[2] || __TURBOPACK__imported__module__$5b$project$5d2f$Time__capsule$2f$Gift__Time__Capsule$2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].ZeroAddress;
...
_s(HomePage, "M9CLEcMbPulqwCa90Ho+tmeWvog=");
_c = HomePage;
// --- Sub Components ---
