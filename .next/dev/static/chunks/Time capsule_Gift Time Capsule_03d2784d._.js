...
function CapsulesPage() {
                ...
                rawGifts.forEach({
                    "CapsulesPage.useCallback[fetchCapsules]": (gift)=>{
                        try {
                            ...
                            const isEth = gift.tokenAddress === __TURBOPACK__imported__module__$5b$project$5d2f$Time__capsule$2f$Gift__Time__Capsule$2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].ZeroAddress;
                            const tokenSymbol = isEth ? "ETH" : "USDC";
                            const decimals = isEth ? 18 : 6;
                            const formattedAmount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Time__capsule$2f$Gift__Time__Capsule$2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$utils$2f$units$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatUnits"])(gift.amount, decimals);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Time__capsule$2f$Gift__Time__Capsule$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CapsulesPage.useEffect": ()=>{
            const timers = [];
            myReceivedCapsules.forEach({
                "CapsulesPage.useEffect": (capsule)=>{
                    if (!capsule.isUnlocked && !capsule.isWithdrawn && capsule.unlockDate) {
                        ...
                        if (timeUntilUnlock > 0 && timeUntilUnlock < 86400000) {
                            const timerId = setTimeout({
                                "CapsulesPage.useEffect.timerId": ()=>{
                                    setMyReceivedCapsules({
                                        "CapsulesPage.useEffect.timerId": (currentCapsules)=>currentCapsules.map({
                                                "CapsulesPage.useEffect.timerId": (c)=>{
                                                    if (c.id === capsule.id) {
                                                        return {
                                                            ...c,
                                                            isUnlocked: true,
                            ...
                            }["CapsulesPage.useEffect.timerId"], timeUntilUnlock + 1000); // Add 1s buffer
                            timers.push(timerId);
                        }
                    }
                }
    ...
    const handleClaim = async ()=>{
        ...
        setIsClaiming(true);
        try {
            const contract = new __TURBOPACK__imported__module__$5b$project$5d2f$Time__capsule$2f$Gift__Time__Capsule$2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$contract$2f$contract$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Contract"](CONTRACT_ADDRESS, CONTRACT_ABI, signer);
...
//# sourceMappingURL=Time%20capsule_Gift%20Time%20Capsule_03d2784d._.js.map